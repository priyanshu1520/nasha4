...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.html" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><img src="images/logoMain.png" alt="" style="    
    width: 16%;
    padding-left: 37px;
    margin-top: -4px;
    margin-left: -31px;
    margin-bottom: -4px;"></i>&nbsp Healing Junction</h4></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#admin" role="tab" aria-controls="admin" aria-selected="false">Center</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#mainadmin" role="tab" aria-controls="mainadmin" aria-selected="false">admin</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                             ...
                             <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Login as Center</h3>
                            ...
                            <div class="tab-pane fade show" id="mainadmin" role="tabpanel" aria-labelledby="mainadmin-tab">
                                <h3  class="register-heading">Login as admin</h3>
                                <form method="post" action="func6.php">
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="User Name *" name="username3" onkeydown="return alphaOnly(event);" required/>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="submit" class="btnRegister" name="mainadmin" value="Login"/>
                                    </div>
                                </div>
                            </form>
                            </div>
