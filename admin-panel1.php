          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Therapist" name="spec">Therapist</option>
                      <option value="Psychiatraist" name="spec">Psychiatraist</option>
                      <option value="Neurologist" name="spec">Neurologist</option>
                      <option value="Medicine" name="spec">Medicine</option>
                    </select>
                    </div><br><br>
